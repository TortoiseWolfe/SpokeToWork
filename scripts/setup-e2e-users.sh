...
if ! docker compose ps spoketowork | grep -q "Up"; then
    echo "❌ Error: Docker container 'spoketowork' is not running"
...
echo ""
echo "Run E2E tests:"
echo "  docker compose exec spoketowork pnpm exec playwright test tests/e2e/messaging/"
echo ""
