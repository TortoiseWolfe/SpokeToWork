...
docker compose exec spoketowork pnpm exec supabase db diff
...
docker compose exec spoketowork pnpm test src/lib/messaging/__tests__/
...
docker compose exec spoketowork pnpm test tests/integration/messaging/
...
- **GitHub Issues**: https://github.com/TortoiseWolfe/SpokeToWork/issues
- **Supabase Discord**: https://discord.supabase.com
- **SpokeToWork Discussions**: https://github.com/TortoiseWolfe/SpokeToWork/discussions
