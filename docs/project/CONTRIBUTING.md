...
docker compose exec spoketowork pnpm dev       # Dev server
docker compose exec spoketowork pnpm test      # Run tests
docker compose exec spoketowork pnpm lint      # Run linting
docker compose exec spoketowork pnpm format    # Format code
docker compose exec spoketowork pnpm storybook  # Storybook
docker compose exec spoketowork pnpm type-check # TypeScript
```
...
| Script                                               | Description                      |
| ---------------------------------------------------- | -------------------------------- |
| `docker compose exec spoketowork pnpm dev`           | Start Next.js development server |
| `docker compose exec spoketowork pnpm build`         | Build for production             |
| `docker compose exec spoketowork pnpm test`          | Run Vitest tests                 |
| `docker compose exec spoketowork pnpm test:coverage` | Generate coverage report         |
| `docker compose exec spoketowork pnpm lint`          | Run ESLint                       |
| `docker compose exec spoketowork pnpm format`        | Format code with Prettier        |
| `docker compose exec spoketowork pnpm format:check`  | Check formatting without changes |
| `docker compose exec spoketowork pnpm type-check`    | Run TypeScript type checking     |
| `docker compose exec spoketowork pnpm storybook`     | Start Storybook development      |
...
- Review [existing issues](https://github.com/TortoiseWolfe/SpokeToWork/issues)
- Ask in discussions
