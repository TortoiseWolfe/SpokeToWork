...
- React 19.1.0 (already in SpokeToWork)
...
- Vitest (unit tests) - already in SpokeToWork
- Playwright (E2E tests) - already in SpokeToWork
- Pa11y (accessibility) - already in SpokeToWork
