...
docker compose exec spoketowork pnpm test src/utils/consent
docker compose exec spoketowork pnpm test src/contexts/Consent
docker compose exec spoketowork pnpm test src/components/privacy

# Run integration tests
docker compose exec spoketowork pnpm test src/tests/consent
