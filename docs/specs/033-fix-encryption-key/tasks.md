...
- [x] T002 [P] Verify TypeScript compilation passes before changes: `docker compose exec spoketowork pnpm run type-check`
...
- [x] T012 [US2] Verify TypeScript compilation with new signature
  - Run: `docker compose exec spoketowork pnpm run type-check`
...
- [x] T016 [P] Run full type-check: `docker compose exec spoketowork pnpm run type-check`
