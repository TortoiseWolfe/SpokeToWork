...
- [x] T002 [P] Create UnifiedSidebar component directory structure using `docker compose exec spoketowork pnpm run generate:component`
...
- [x] T019 Run full test suite: `docker compose exec spoketowork pnpm test`
- [x] T020 Run type check: `docker compose exec spoketowork pnpm run type-check`
- [x] T021 Run linter: `docker compose exec spoketowork pnpm run lint`
...
- Use `docker compose exec spoketowork` prefix for all commands
