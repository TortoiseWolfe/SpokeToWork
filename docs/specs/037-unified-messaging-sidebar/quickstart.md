...
- Docker running with SpokeToWork container
...
docker compose exec spoketowork pnpm test ConnectionManager
docker compose exec spoketowork pnpm test UnifiedSidebar
