...
As a user of SpokeToWork's payment system, I need to create an account and authenticate securely so that I can make payments and view my payment history without anyone else being able to access my financial information.
...
2. **Given** I authorize the application on GitHub, **When** I return to SpokeToWork, **Then** I am automatically signed in
