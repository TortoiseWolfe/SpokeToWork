  ...
  it('computes aggregates from three parallel fetches', async () => {
    mockFrom.mockImplementation((table: string) => {
      if (table === 'bicycle_routes') {
        return mockTable([
          { id: 'r1', is_active: true, metro_area_id: 'm1', distance_miles: 10 },
          { id: 'r2', is_active: true, metro_area_id: 'm1', distance_miles: 20 },
          { id: 'r3', is_active: false, metro_area_id: 'm2', distance_miles: null },
          { id: 'r4', is_active: true, metro_area_id: null, distance_miles: 30 },
        ]);
      }
      if (table === 'route_companies') {
        // r1 has 3 stops, r2 has 1, r3 and r4 have 0
        return mockTable([
          { route_id: 'r1' }, { route_id: 'r1' }, { route_id: 'r1' },
          { route_id: 'r2' },
        ]);
      }
