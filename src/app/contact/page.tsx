...
export const metadata: Metadata = {
  title: 'Contact Us | SpokeToWork',
  description:
    "Get in touch with the SpokeToWork team. We'd love to hear from you!",
  keywords: ['contact', 'support', 'help', 'feedback', 'SpokeToWork'],
  openGraph: {
    title: 'Contact Us | SpokeToWork',
    description: 'Get in touch with the SpokeToWork team',
    type: 'website',
  },
};
...
export default function ContactPage() {
  return (
    <div className="container mx-auto min-h-full px-4 py-6 sm:py-8 md:py-12">
