...
export const metadata: Metadata = {
  title: 'Privacy Policy - SpokeToWork',
  description:
    'Learn how SpokeToWork protects your privacy and handles your personal information.',
};
    ...
    <div className="container mx-auto max-w-4xl px-4 py-6 sm:py-8 md:py-12">
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Welcome to SpokeToWork. We are committed to protecting your privacy
