...
export function ModerationDetailPanel({
  ...
  return (
    <aside
      className="fixed right-0 top-0 z-20 flex h-full w-full max-w-md flex-col border-l border-base-300 bg-base-100 shadow-xl"
      data-testid="moderation-detail-panel"
      aria-label="Contribution details"
    >
      <header className="flex items-start justify-between border-b border-base-300 p-4">
        <div>
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        <dl className="space-y-2 text-sm">
          {contribution.address && (
            <div>
              <dt className="font-semibold text-base-content/70">Address</dt>
              <dd>{contribution.address}</dd>
            </div>
          )}
          {contribution.phone && (
            <div>
              <dt className="font-semibold text-base-content/70">Phone</dt>
          ...
          {contribution.website && (
            <div>
              <dt className="font-semibold text-base-content/70">Website</dt>
              <dd>
                <a
          ...
          {contribution.notes && (
            <div>
              <dt className="font-semibold text-base-content/70">Notes</dt>
      ...
      <footer className="space-y-2 border-t border-base-300 p-4">
        <button
          type="button"
