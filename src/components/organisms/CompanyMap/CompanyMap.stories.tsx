...
const demoMarkers: MapMarker[] = [
  ...
  { id: 'company-demo-2', position: [40.758, -73.9855], popup: 'Times Sq Co', variant: 'active-route' },
  { id: 'company-demo-3', position: [40.7484, -73.9857], popup: 'ESB Co', variant: 'next-ride' },
];
