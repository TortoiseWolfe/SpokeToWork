    ...
    >
      {isStartPoint ? (
        <div className="relative" data-testid="start-marker-inner">
          ...
          />
          <div
            className={`relative flex h-8 w-8 items-center justify-center rounded-full border-[3px] border-white ${isSelected ? 'ring-4 ring-offset-2 ring-info' : ''}`}
            style={{
              backgroundColor: color,
        ...
        <div className="relative">
          ...
          />
          <div
            className={`relative flex h-6 w-6 items-center justify-center rounded-full border-2 border-white shadow-lg ${isSelected ? 'ring-4 ring-offset-2 ring-info' : ''}`}
            style={{ backgroundColor: color }}
          >
        ...
        <div
          className={`h-6 w-6 rounded-full border-2 border-white ${isSelected ? 'ring-4 ring-offset-2 ring-info' : ''}`}
          style={{
            backgroundColor: color,
