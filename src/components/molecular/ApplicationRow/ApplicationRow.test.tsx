...
describe('ApplicationRow', () => {
  ...
  // Regression guard. `priority` is the JOB SEEKER's private 1-5 ranking of
  // this employer, stored in their own hunt tracker. The employer row used to
  // render it. It is now excluded from the employer_applications view and from
  // the EmployerApplication type; this asserts the UI stays consistent with
  // that, since a fixture could still carry the field.
  it('does not render the job seeker private priority ranking', () => {
    render(
      wrap(
        <ApplicationRow
          application={makeApp()}
