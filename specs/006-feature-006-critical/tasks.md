...
- [ ] T040 [P] Run full E2E test suite: `docker compose exec spoketowork pnpm exec playwright test tests/e2e/messaging/`
- [x] T041 [P] Run unit tests: `docker compose exec spoketowork pnpm test`
- [x] T042 [P] Run type-check: `docker compose exec spoketowork pnpm run type-check`
- [x] T043 [P] Run linting: `docker compose exec spoketowork pnpm run lint`
