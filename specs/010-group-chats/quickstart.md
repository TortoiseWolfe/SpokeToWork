...
docker compose exec spoketowork pnpm test src/services/messaging/group

# E2E tests for group workflows
docker compose exec spoketowork pnpm exec playwright test tests/e2e/messaging/group
