...
- [x] T019 [US1] Run tests: `docker compose exec spoketowork pnpm test welcome-service`

- [x] T020 [US1] Manual verification: Sign up new user, check conversations for welcome message from spoketowork
...
- [x] T033 [POLISH] Run full test suite: `docker compose exec spoketowork pnpm test`

- [x] T034 [POLISH] Run type check: `docker compose exec spoketowork pnpm type-check`

- [x] T035 [POLISH] Run linter: `docker compose exec spoketowork pnpm lint`
