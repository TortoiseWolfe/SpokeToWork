...
A new user signs up and initializes their encryption keys. They automatically receive a welcome message from SpokeToWork admin explaining E2E encryption.
...
- **Admin User**: UUID `00000000-0000-0000-0000-000000000001`, username `spoketowork`
...
2. Creates admin profile (username: `spoketowork`) if missing
