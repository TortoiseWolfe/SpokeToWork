...
- [x] T001 Run `docker compose exec spoketowork pnpm run type-check` and record current state
- [x] T002 [P] Run `docker compose exec spoketowork pnpm run lint` and record current warnings
...
- `docker compose exec spoketowork pnpm run test:a11y` passes
